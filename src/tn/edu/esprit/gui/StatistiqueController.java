...
public class StatistiqueController implements Initializable {
    ...
    @FXML
    private Label sommeActAttent;
    @FXML
    private Label sommeActTermine;
    ...
    for (Map.Entry<String, Integer> entry : nombreRessourcesParTerrain.entrySet()) {
        statistiques.append("Terrain ").append(entry.getKey()).append("  :   ").append(entry.getValue()).append("   Species de ressources\n");
    }
